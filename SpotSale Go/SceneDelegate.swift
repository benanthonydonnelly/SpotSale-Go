...
//
//        guard let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "TabVC") as? TabController else {
//            fatalError("Could not instantiate HomeVC!")
//        }
//        window.rootViewController = vc
//
//        self.window = window
//        self.window?.layer.setValue("test", forKey: "one")
//
...
//        tabController.viewControllers = [createMainViewController()]
